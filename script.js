...
// Función para abrir WhatsApp con el producto
...
const particles = [];
const particleCount = window.innerWidth < 600 ? 40 : 80; // menos partículas en móviles
...
// Ajuste del canvas al cambiar tamaño de ventana
